  ...
  module Blog
    ...
    class BlogData
      ...
      def initialize(app, options={}, controller=nil)
        ...
        @matcher_indexes = {}
        options.sources.scan(/:lang|:category|:subcategory|:year|:month|:day|:title/).
        ...
        resources.each do |resource|
          if resource.path =~ path_matcher
            ...
            resource.destination_path = options.permalink.
              ...
              sub(':category', resource.category.to_s).
              sub(':subcategory', resource.subcategory.to_s).
            ...
            article_path = options.sources.
              ...
              sub(':category', match[@matcher_indexes["category"]]).
              sub(':subcategory', match[@matcher_indexes["subcategory"]]).
            ...
            resource.destination_path = options.permalink.
              sub(':lang', article.lang.to_s).
              sub(':category', article.category.to_s).
              sub(':subcategory', article.subcategory.to_s).
